export interface GalaxyUnivers {
  slug: string;
  label: string;
}
...
export const PILLAR_COLORS: Record<string, { accent: string; bg: string; border: string }> = {
...
export function catKey(label: string): string {
