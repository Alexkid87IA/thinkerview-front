...
export default function ArticlesPage() {
  return (
    <Layout>
      <section className={s.hero} aria-label="Articles et décryptages">
        ...
        <motion.p className={s.heroDeck} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.8 }}>
          Analyses de fond, enqu&ecirc;tes sourc&eacute;es, d&eacute;cryptages p&eacute;dagogiques produits par la r&eacute;daction.
        </motion.p>
      </section>

      <PlaceholderSection id="toolbar" title="Filtres & tri" chapterNum="02" chapterLabel="Filtres & tri" />
      <PlaceholderSection id="articles-grid" title="Grille d'articles" chapterNum="03" chapterLabel="Grille d'articles" />
